...
const UserDetails = (user) => {
	// NOTE: When an item MIGHT be there, use this method to check { expression && <RenderItem /> }
	return (
		<div>
...
// the 'shape' proptypes object is used to check that a given structure is there
// rather than saying specific items should be required
